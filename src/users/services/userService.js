...
export const registerService = () => {
  ...
  REGISTER_FIRST_NAME.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_FIRST_NAME_ERROR,
      REGISTER_SUBMIT_BTN,
  ...
  REGISTER_LAST_NAME.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_LAST_NAME_ERROR,
      REGISTER_SUBMIT_BTN,
  ...
  REGISTER_CUNTRY.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_CUNTRY_ERROR,
      REGISTER_SUBMIT_BTN,
  ...
  REGISTER_STATE.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_STATE_ERROR,
      REGISTER_SUBMIT_BTN,
  ...
  REGISTER_CITY.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_CITY_ERROR,
      REGISTER_SUBMIT_BTN,
  ...
  REGISTER_EMAIL.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_EMAIL_ERROR,
      REGISTER_SUBMIT_BTN,
  ...
  REGISTER_HOUSENUMBER.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_HOUSENUMBER_ERROR,
      REGISTER_SUBMIT_BTN,
  ...
  REGISTER_PASSWORD.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_PASSWORD_ERROR,
      REGISTER_SUBMIT_BTN,
  ...
  REGISTER_PHONE.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_PHONE_ERROR,
      REGISTER_SUBMIT_BTN,
  ...
  REGISTER_STREET.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_STREET_ERROR,
      REGISTER_SUBMIT_BTN,
  ...
  REGISTER_ZIP.addEventListener("input", (event) =>
    onInputChange(
      event,
      REGISTER_ZIP_ERROR,
      REGISTER_SUBMIT_BTN,
